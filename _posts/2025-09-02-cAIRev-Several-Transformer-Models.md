...
![](/assets/img/posts/S_T_M/Encoder-only%20Transformer.png){: width="589" height="972" }
...
![](/assets/img/posts/S_T_M/Decoder-only%20Transformer.png){: width="589" height="972" }
...
![](/assets/img/posts/S_T_M/Transformer%20Architecture.png){: width="589" height="972" }
